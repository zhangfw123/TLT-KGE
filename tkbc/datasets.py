...
class TemporalDataset(object):
    def __init__(self, name: str):
        ...
        self.n_entities = int(max(max(max(maxis[0], maxis[2]), max(maxis2[0], maxis2[2])), max(maxis3[0], maxis3[2])) + 1)
